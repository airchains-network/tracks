...
import (
	...
	"github.com/airchains-network/decentralized-sequencer/da/mockda"
...
func DALayer(daData []byte, batchNumber int) (string, error) {
	...
	daConfig := types.DAConfigType{
		DALayer:    "avail",                  // avail, celestia, eigen, mockdb
		DARpc:      "http://127.0.0.1:7000/", // avail http://127.0.0.1:7000/,  celestia http://localhost:26658", eigen https://disperser-goerli.eigenda.xyz:443
